...
#### Fig B: plot of mean naturalness ratings in by context ----
...
# Mandelkern et al 2020 used linear regression with their data, so JT/JD will do the same

m = lmer(Answer ~ context + (1+context|subject), data=subset(results[results$trigger == "sure",]))
summary(m)
